...
class UpdateExpiredCustomers extends Command
{
    ...
    // /**
    //  * Apply RADIUS actions – only for active, grace, expired.
    //  * Suspended is never processed.
    //  */
    // private function applyExternalActions(Customer $customer, string $newStatus, RadiusService $radius): void
    // {
    //     switch ($newStatus) {
    //         case 'active':
    //             $radius->enableCustomer($customer);
    ...
    //             break;
    //         case 'expired':
    //             Log::info('Blocking expired customer', ['username' => $customer->username]);
    //             $radius->disableCustomer($customer);
    //             break;
    //         default:
    //             // Should never happen – we only process the three statuses above.
    //             Log::warning('Unexpected status in cron', [
    //                 'username' => $customer->username,
    //                 'status'   => $newStatus,
    //             ]);
    //             break;
