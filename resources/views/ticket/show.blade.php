            ...
            <div class="col-lg-12">
                ...
                <div class="card card-info mb-3">
                    ...
                    <div class="card-body">
                        ...
                        <p><strong>Created By:</strong> {{ $ticket->creator->name ?? 'System' }}</p>
                    </div>
                </div>
                    ...
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            <form method="POST" action="{{ route('tickets.reply', $ticket->id) }}">
                                @csrf
                                <div class="form-group">
                                    <textarea name="message" rows="4" class="form-control" placeholder="Write reply..." required></textarea>
                                </div>
                ...
                {{-- ⛔ INTERNAL NOTE – hidden when closed --}}
                @if($ticket->status !== 'closed')
                    <div class="card">
                        <div class="card-header">
                        ...
                        <div class="card-body">
                            <form method="POST" action="{{ route('tickets.internal-note', $ticket->id) }}">
                                @csrf
                                <div class="form-group">
                                    <textarea name="message" rows="3" class="form-control" placeholder="Internal note..." required></textarea>
                                </div>
                                <button class="btn btn-warning">Add Internal Note</button>
                            </form>
                        </div>
                    </div>
                @endif
