...
class Customer extends Model
{
    ...
    public function activeSessionTime()
    {
        return $this->rad()
            ->selectRaw("
                username,
    ...
    public function activeSessionsWithDataInMB()
    {
        return $this->sessions()
            ->selectRaw("
                username,
                acctinputoctets / POWER(1024, 2) as upload_mb,
                acctoutputoctets / POWER(1024, 2) as download_mb
            ")
            ->whereNull('acctstoptime') // Only active sessions
            ->get();
    }
