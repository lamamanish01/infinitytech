...
class RoleController extends Controller
{
    function __construct()
    {
         ...
         $this->middleware('permission:view permissions', ['only' => ['create','store']]);
         $this->middleware('permission:view permissions', ['only' => ['edit','update']]);
         $this->middleware('permission:view permissions', ['only' => ['destroy']]);
    }
