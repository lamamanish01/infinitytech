...
class RechargeController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($request->provide_grace && $customer->latestRecharge && !$customer->latestRecharge->hasGracePeriod()) {
        $gracePeriodEnd = $expiryDate->copy()->addDays(3); // Add 3 days to the expiry date
    }
