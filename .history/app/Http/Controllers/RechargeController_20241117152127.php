...
class RechargeController extends Controller
{
    ...
    public function create($customerId)
    {
        ...
        return view('recharges.create', compact('customer', compact('internetplan')),);
    }
    ...
    public function store(Request $request, Recharge $recharge)
    {
        ...
        $internetplan = InternetPlan::find($request->internetplan);
        ...
        $recharge->internetplan = $internetplan;
        ...
        $recharge->syncWithRad($username, $password, $rate_limit, $expiry_date);
