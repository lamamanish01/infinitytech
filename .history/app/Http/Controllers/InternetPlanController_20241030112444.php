...
class InternetPlanController extends Controller
{
    ...
    {
        $bandwidth = Bandwidth::pluck('name');
        $internetplan = InternetPlan::get();
        $plan_type = InternetPlanType::pluck('type_name')->implode;

        return view('internetplan.create', compact('bandwidth', 'plan_type', 'internetplan'));
    }
    ...
    {
        $bandwidth = Bandwidth::pluck('name');
        $plan_type = InternetPlanType::pluck('type_name', 'id');
        return view('internetplan.edit', compact('internetplan', 'bandwidth', 'plan_type'));
    }
