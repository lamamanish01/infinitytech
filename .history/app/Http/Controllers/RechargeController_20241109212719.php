...
class RechargeController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $recharge->expiry_date = $expiry_date;
        ...
        return redirect()->route('customers.index', $cusotmer->id)->with('success', 'Recharge successful' . ($grace_period ? ' with grace period added!' : '!'));
    }
