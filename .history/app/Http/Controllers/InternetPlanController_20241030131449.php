...
class InternetPlanController extends Controller
{
    ...
    {
        $bandwidths = Bandwidth::get();
        // $hasBandwidth = $internetplan->bandwidth->pluck('bandwidth_name');
        return view('internetplan.edit', compact('internetplan', 'bandwidths', 'hasBandwidth'));
    }
