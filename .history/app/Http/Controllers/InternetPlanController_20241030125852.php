...
class InternetPlanController extends Controller
{
    ...
    {
        $bandwidths = Bandwidth::pluck('name', 'i');
        $hasBandwidth = $internetplan->bandwidth->pluck('name');
        return view('internetplan.edit', compact('internetplan', 'hasBandwidth', 'bandwidths'));
    }
