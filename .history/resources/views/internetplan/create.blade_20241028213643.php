                        ...
                        <div class="card-body">
                            <form action="{{route('bandwidth.store')}}" method="POST">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col">
                                        <div class="col-sm-4">
                                            <select name="internet_plan_type" class="custom-select">
                                                <option value="#">{{$plan_tyo}}</option>
                                            </select>
                                            <input type="text" class="form-control" name="duration" placeholder="Enter Plan Type">
                                        </div>
                                    </div>
                                </div>
                                <div class="btn-group">
