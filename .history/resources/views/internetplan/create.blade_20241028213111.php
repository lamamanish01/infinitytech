                        ...
                        <div class="card-body">
                            <form action="{{route('bandwidth.store')}}" method="POST">
                                    ...
                                    <div class="col">
                                        <div class="col-sm-12">
                                            <select name="bandwidth_name" class="custom-select">
                                                <option value="">Select Bandwidth Name</option>
                                                <option value="">{{$bandwidth->pluck('name')->implode(' ')}}</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col">
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" name="duration" placeholder="Enter Plan Validity Name">
                                        </div>
                                    </div>
                                    <div class="col">
                                        <label class="col-sm-2 col-form-label">Plan Type :</label>
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control" name="duration" placeholder="Enter Duration Name">
                                        </div>
                                    </div>
                                </div>
                                <div class="btn-group">
