                                    ...
                                    <div class="col">
                                        <div class="col-sm-12">
                                            <select name="bandwidth_name" class="custom-select">
                                                ...
                                                <!-- Loop through bandwidths and show each option only if it's not the selected one -->
                                                @foreach($bandwidths as $bandwidth)
                                                    @if($bandwidth !== $internetplan->bandwidth_name)
                                            ...
                                            <select name="bandwidth_name" class="custom-select">
                                                ...
                                                @foreach($plan_types as $plan_type)
                                                    <option value="{{ $plan_type }}"
                                                        {{ isset($internetplan->type) && $internetplan->type == $plan_type ? 'selected' : '' }}>
                                                        {{ $plan_type }}
                                                    </option>
                                                @endforeach
                                            </select>
