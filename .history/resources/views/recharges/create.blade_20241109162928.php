                        ...
                        <div class="card-body">
                            <form action="{{route('recharges.store')}}" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="hidden" name="internetplan_id" value="{{$customer->internetplan->anme}}">
                                    <select name="internetplan_id" class="custom-select">
                                        <option value="{{$customer->internetplan->id}}">{{$customer->internetplan->name}}</option>
                                    </select>
                                </div>
