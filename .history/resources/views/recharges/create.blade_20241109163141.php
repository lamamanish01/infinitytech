                    ...
                    <div class="card card-info">
                        ...
                        <div class="card-body">
                            <form action="{{route('recharges.store')}}" method="POST">
                                ...
                                <input type="hidden" name="customer_id" value="{{$customer->internetplan->id}}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="username" value="{{$customer->internetplan->name}}" readonly>
                                </div>
