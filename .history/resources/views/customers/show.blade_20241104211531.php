            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <li class="nav-item"><a class="nav-link" href="#settings" data-bs-toggle="tab">Statistics</a></li>
                        <li class="nav-item"><a class="nav-link" href="#settings" data-bs-toggle="tab">Billing</a></li>
                        </ul>
                    </div>
                </div>
            </div>
