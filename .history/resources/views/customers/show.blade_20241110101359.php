              ...
              <div class="tab-content" id="myTabContent">
                <div class="tab-pane fade show active" id="info" role="tabpanel" aria-labelledby="home-tab">
                    ...
                    <div class="row">
                        ...
                        <!-- Button for regular recharge -->
                        <button type="submit" name="provide_grace" value="0" class="btn btn-primary">Recharge</button>

                        <!-- Button for recharge with grace period -->
                        <button type="submit" name="provide_grace" value="1" class="btn btn-secondary">Recharge with Grace</button>
                        {{--  <div class="form-check">
                            <input type="checkbox" name="provide_grace" id="provide_grace" class="form-check-input">
                            <label for="provide_grace" class="form-check-label">Provide 3-day Grace Period</label>
                        </div>  --}}
                    </div>
                </div>
