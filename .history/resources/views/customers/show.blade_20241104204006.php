              ...
              <div class="card card-primary card-outline">
                ...
                <div class="card-body">
                  ...
                  <ul class="nav nav-tabs" id="custom-content-below-tab" role="tablist">
                    ...
                    <li class="nav-item">
                      <a class="nav-link" id="custom-content-below-profile-tab" data-toggle="pill" href="#custom-content-below-profile" role="tab" aria-controls="custom-content-below-profile" aria-selected="false"></a>
                    </li>
                    <li class="nav-item">
