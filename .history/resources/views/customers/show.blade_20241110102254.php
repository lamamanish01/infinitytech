                ...
                <div class="tab-pane fade show active" id="info" role="tabpanel" aria-labelledby="home-tab">
                    ...
                    <div class="row">
                        ...
                        <form action="{{ route('recharges.store') }}" method="POST">
                            @csrf
                            <!-- Other form fields for customer and plan selection -->

                            <div class="form-check">
                                <input type="checkbox" class="form-check-input" name="provide_grace" id="provide_grace" value="1">
                                <label class="form-check-label" for="provide_grace">Provide 3-day Grace Period</label>
                            </div>
