                        ...
                        <div class="card-body">
                            <form action="{{route('menus.update')}}" method="POST">
                                ...
                                <div class="form-group">
                                    <label>Title:</label>
                                    <input type="text" class="form-control" name="title" placeholder="Enter Title" value="{{$menu->title}}">
                                </div>
                                <div class="form-group">
                                    <label>URL:</label>
                                    <input type="text" class="form-control" name="url" placeholder="Enter URL" value="{{$menu->title}}">
                                </div>
                                <div class="form-group">
                                    <label>Icon:</label>
